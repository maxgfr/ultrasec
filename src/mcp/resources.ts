...
export const SKILL_NAME = "ultrasec";
...
// them:
//
//   <payload>/scripts/ultrasec.mjs  → <payload>/SKILL.md              (installed skill)
//   <repo>/scripts/ultrasec.mjs     → <repo>/skills/ultrasec/SKILL.md (repo-root bundle)
//   <repo>/src/mcp/resources.ts     → <repo>/skills/ultrasec/SKILL.md (source tree, tests)
//
